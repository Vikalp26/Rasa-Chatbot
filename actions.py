...
class ActionUserNamenhelp(Action):
	def name(self):
		return 'Action_User_Name_nhelp'
		
	def run(self, dispatcher, tracker, domain):
		nam = tracker.get_slot('name')
		response = """Hi {}! what can I help you with?""".format(nam)
		
		dispatcher.utter_message(response)
		return [SlotSet('name', nam)]
...
class ActionModule(Action):
	...
	def run(self, dispatcher, tracker, domain):
		...
		if mod in my_dict:
			...
			reply = "It is so odd that I don't have this info on vE. I'm afraid you have to contact the support team at ObiE@ValeurHR.com"
